...
Modal.prototype.action=function(){
    ...
    TEXT.innerHTML = this.text33;
}
// 인스턴스
let modal = [new Modal('title01','images/pic01.png','2001','프로그램1','http:www.aa1.com','text01'),
             new Modal('title02','images/pic02.png','2002','프로그램2','http:www.aa2.com','text02'), 
             new Modal('title03','images/pic03.png','2003','프로그램3','http:www.aa3.com','text03'), 
             new Modal('title04','images/pic04.png','2004','프로그램4','http:www.aa4.com','text04'), 
             new Modal('title05','images/pic05.png','2005','프로그램5','http:www.aa5.com','text05')]
// 함수 <- 이벤트
function play(){
